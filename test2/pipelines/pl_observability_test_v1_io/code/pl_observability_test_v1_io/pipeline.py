...
from pl_observability_test_v1_io.graph import *
...
def main():
    ...
    spark.conf.set("prophecy.metadata.pipeline.uri", "pipelines/pl_observability_test_v1_io")
    registerUDFs(spark)
    MetricsCollector.instrument(spark = spark, pipelineId = "pipelines/pl_observability_test_v1_io", config = Config)(
