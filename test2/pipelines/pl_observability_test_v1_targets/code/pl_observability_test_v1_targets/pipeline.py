...
from pl_observability_test_v1_targets.graph import *
...
def main():
    ...
    spark.conf.set("prophecy.metadata.pipeline.uri", "pipelines/pl_observability_test_v1_targets")
    registerUDFs(spark)
    MetricsCollector.instrument(spark = spark, pipelineId = "pipelines/pl_observability_test_v1_targets", config = Config)(
